...
export default function SettingsPage() {
  ...
  const [backupSettings, setBackupSettings] = useState({ email: "", time: "02:00", auto: false });
  ...
  return (
    <div className="space-y-6 max-w-2xl" data-testid="settings-page">
      ...
      <Card className="p-6 space-y-4">
        ...
        <div><Label>البريد الإلكتروني للنسخ</Label><Input type="email" value={backupSettings.email} onChange={(e) => setBackupSettings({ ...backupSettings, email: e.target.value })} data-testid="backup-email" placeholder="admin@example.com"/></div>
